...
Public reading is available without an account where a record is published, independently reviewed and safety-approved. Creation, review, publication, merge, research and dataset operations require File 00-aware capabilities plus File 06 native object/state/type scope. The 2.4.11 candidate also requires explicit editor knowledge-type assignment and reviewer assignment for governed review decisions.
