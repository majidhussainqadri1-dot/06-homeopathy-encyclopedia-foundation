...
define( 'HE_CONTRACT_VERSION', '2.4.16' );
...
function he_contract_descriptor() {
	...
	return array(
		...
		'events'=>array_values(array_unique($events)),'privacy_class'=>'mixed-public-restricted','fixed_type_count'=>count(HE_V22_Type_Schemas::schemas()),'future_requirement_count'=>18,'future_hardening_version'=>'2.4.16',
