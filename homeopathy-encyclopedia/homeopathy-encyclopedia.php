...
define( 'HE_CONTRACT_VERSION', '2.4.17' );
...
require_once HE_DIR . 'includes/class-he-v242-research-browse.php';
require_once HE_DIR . 'includes/class-he-v242-research-authoring.php';
require_once HE_DIR . 'includes/class-he-v242-language-surfaces.php';
require_once HE_DIR . 'includes/class-he-v242-watchlist.php';
require_once HE_DIR . 'includes/class-he-v242-reference-graph.php';
...
function he_contract_descriptor() {
	...
	return array(
		...
		'events'=>array_values(array_unique($events)),'privacy_class'=>'mixed-public-restricted','fixed_type_count'=>count(HE_V22_Type_Schemas::schemas()),'future_requirement_count'=>18,'future_hardening_version'=>'2.4.17',
