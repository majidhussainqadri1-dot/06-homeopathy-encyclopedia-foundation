...
function he_contract_descriptor() {
	...
	$events[] = 'KnowledgeTranslationPublished.v1';
	return array(
		'owner'             => 'file-06',
		...
		'reliability'       => array( 'idempotency_required' => true, 'bounded_retry' => true, 'dead_letter' => true, 'outbox_reconciliation' => true, 'scheduled_publication_revalidation' => true, 'future_impact_queue' => true, 'human_review_for_external_metadata' => true, 'rotating_full_corpus_maintenance' => true, 'provider_response_bounded' => true ),
...
function he_start_v2() {
	...
	try {
		...
		HE_V24_Audit80_Hardening::maybe_upgrade();
