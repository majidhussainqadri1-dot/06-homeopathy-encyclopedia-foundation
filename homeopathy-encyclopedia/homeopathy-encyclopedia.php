...
require_once HE_DIR . 'includes/class-he-v243-fifth-audit.php';
...
function he_start_v2() {
	...
	HE_V242_Third_Audit::hooks(); HE_V242_Runtime_Corrections::hooks(); HE_V242_Multilingual::hooks(); HE_V242_Research_Browse::hooks(); HE_V242_Research_Authoring::hooks(); HE_V242_Language_Surfaces::hooks(); HE_V242_Translation_Compat::hooks(); HE_V242_Watchlist::hooks(); HE_V242_Reference_Graph::hooks(); HE_V242_Research_Immutability::hooks(); HE_V242_Public_Translation_Guard::hooks(); HE_V242_Language_Migration::hooks(); HE_V243_Fifth_Audit::hooks();
