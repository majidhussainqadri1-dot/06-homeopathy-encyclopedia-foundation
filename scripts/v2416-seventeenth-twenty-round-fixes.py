...
if ROUND == 1:
    new_routes = '''\tpublic static function register_routes() {
...
'''
    ...
    new_review = '''\tpublic static function rest_review_research( WP_REST_Request $request ) {
\t\t$public_id = strtolower( sanitize_text_field( (string) $request['id'] ) );
...
'''
    ...
    new_create_integrity = '''\tpublic static function rest_create_research_integrity( WP_REST_Request $request ) {
\t\t$public_id = strtolower( sanitize_text_field( (string) $request['id'] ) );
...
'''
    ...
    new_apply = '''\tpublic static function rest_apply_research_integrity( WP_REST_Request $request ) {
\t\t$public_id = strtolower( sanitize_text_field( (string) $request['id'] ) );
...
'''
    ...
    new_after = '''\tpublic static function after_rest( $response, $handler, $request ) {
...
'''
    ...
    new_schema = '''\tpublic static function required_tables() {
...
'''
    ...
    guard = '''\tpublic function guard_entry_admin_write( $data, $postarr ) {
...
'''
    ...
    new_entry_rollback = '''\tprivate static function rollback_new_entry( $concept_id, $post_id ) {
...
'''
    ...
    new_research_rollback = '''\tprivate static function rollback_new_research( $research_id, $post_id ) {
...
'''
    ...
    new_dto = '''\tpublic static function research_dto( $research_id, $private = false ) {
\t\tglobal $wpdb;
...
'''
    ...
    new_reconcile = '''\tpublic static function reconcile_manual_research_state( $post_id, $post, $update ) {
