...
foreach(array('Version: 2.4.1',"HE_VERSION', '2.4.1","HE_SCHEMA_VERSION', 10","HE_CONTRACT_VERSION', '2.4.1",'future_requirement_count','future_routes_fail_closed_until_ready') as $t){v24_has('bootstrap',$t,'bootstrap '.$t);}
