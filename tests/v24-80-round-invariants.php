...
foreach(array('Version: 2.4.7',"HE_VERSION', '2.4.7","HE_SCHEMA_VERSION', 10","HE_CONTRACT_VERSION', '2.4.7",'future_requirement_count','future_routes_fail_closed_until_ready') as $t){v24_has('bootstrap',$t,'bootstrap '.$t);}
...
if($fail){fwrite(STDERR,"File 06 v2.4 controls FAILED:\n- ".implode("\n- ",$fail)."\n");exit(1);} echo "File 06 first 80-round controls remain enforced under v2.4.7.\n";
