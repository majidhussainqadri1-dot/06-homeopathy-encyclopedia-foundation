...
foreach ( array( 'he_v2_case_baseline', 'he_v2_case_intervention', 'he_v2_case_follow_up', 'he_v2_case_adverse_events', 'he_v2_case_limitations' ) as $field ) {
    $has( $first_save, $field, 'successful-case first-save field ' . $field );
}
