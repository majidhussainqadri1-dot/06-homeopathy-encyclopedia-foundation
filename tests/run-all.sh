...
a="${TMPDIR:-/tmp}/file06-v2.4.3-a.zip"
b="${TMPDIR:-/tmp}/file06-v2.4.3-b.zip"
...
echo "All File 06 v2.4.3 automated checks, corrected third fresh 80-round matrix and deterministic package comparison passed."
