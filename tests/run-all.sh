...
a="${TMPDIR:-/tmp}/file06-v2.4.12-a.zip"
b="${TMPDIR:-/tmp}/file06-v2.4.12-b.zip"
...
echo "All File 06 v2.4.12 automated checks, inherited review matrices, thirteenth ten-round regressions and deterministic package comparison passed."
