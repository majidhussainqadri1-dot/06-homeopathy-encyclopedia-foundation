...
a="${TMPDIR:-/tmp}/file06-v2.4.19-a.zip"
b="${TMPDIR:-/tmp}/file06-v2.4.19-b.zip"
...
echo "All File 06 v2.4.19 automated checks, inherited review matrices, twentieth twenty-round regressions and deterministic package comparison passed."
