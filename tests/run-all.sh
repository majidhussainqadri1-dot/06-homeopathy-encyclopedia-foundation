...
a="${TMPDIR:-/tmp}/file06-v2.4.14-a.zip"
b="${TMPDIR:-/tmp}/file06-v2.4.14-b.zip"
...
echo "All File 06 v2.4.14 automated checks, inherited review matrices, fifteenth ten-round regressions and deterministic package comparison passed."
