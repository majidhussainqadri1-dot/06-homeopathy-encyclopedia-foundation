...
a="${TMPDIR:-/tmp}/file06-v2.4.11-a.zip"
b="${TMPDIR:-/tmp}/file06-v2.4.11-b.zip"
...
echo "All File 06 v2.4.11 automated checks, inherited review matrices, twelfth ten-round regressions and deterministic package comparison passed."
