...
a="${TMPDIR:-/tmp}/file06-v2.4.10-a.zip"
b="${TMPDIR:-/tmp}/file06-v2.4.10-b.zip"
...
echo "All File 06 v2.4.10 automated checks, inherited review matrices, eleventh ten-round regressions and deterministic package comparison passed."
