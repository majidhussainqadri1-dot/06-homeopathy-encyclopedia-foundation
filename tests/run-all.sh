...
a="${TMPDIR:-/tmp}/file06-v2.4.15-a.zip"
b="${TMPDIR:-/tmp}/file06-v2.4.15-b.zip"
...
echo "All File 06 v2.4.15 automated checks, inherited review matrices, sixteenth twenty-round regressions and deterministic package comparison passed."
