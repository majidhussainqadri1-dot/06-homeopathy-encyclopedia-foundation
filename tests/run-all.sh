...
a="${TMPDIR:-/tmp}/file06-v2.4.8-a.zip"
b="${TMPDIR:-/tmp}/file06-v2.4.8-b.zip"
...
echo "All File 06 v2.4.8 automated checks, inherited review matrices, ninth ten-round regressions and deterministic package comparison passed."
