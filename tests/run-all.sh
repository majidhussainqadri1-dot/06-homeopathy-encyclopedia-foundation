...
a="${TMPDIR:-/tmp}/file06-v2.4.4-a.zip"
b="${TMPDIR:-/tmp}/file06-v2.4.4-b.zip"
...
echo "All File 06 v2.4.4 automated checks, inherited review matrices, fifth ten-round regressions and deterministic package comparison passed."
