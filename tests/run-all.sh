...
a="${TMPDIR:-/tmp}/file06-v2.4.5-a.zip"
b="${TMPDIR:-/tmp}/file06-v2.4.5-b.zip"
...
echo "All File 06 v2.4.5 automated checks, inherited review matrices, sixth ten-round regressions and deterministic package comparison passed."
