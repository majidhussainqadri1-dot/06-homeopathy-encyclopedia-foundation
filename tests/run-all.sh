...
a="${TMPDIR:-/tmp}/file06-v2.4.9-a.zip"
b="${TMPDIR:-/tmp}/file06-v2.4.9-b.zip"
...
echo "All File 06 v2.4.9 automated checks, inherited review matrices, tenth ten-round regressions and deterministic package comparison passed."
