...
a="${TMPDIR:-/tmp}/file06-v2.4.16-a.zip"
b="${TMPDIR:-/tmp}/file06-v2.4.16-b.zip"
...
echo "All File 06 v2.4.16 automated checks, inherited review matrices, seventeenth twenty-round regressions and deterministic package comparison passed."
