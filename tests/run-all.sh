...
php "$root/tests/v2419-twentieth-twenty-round-regressions.php"
php "$root/tests/v2420-twenty-first-twenty-round-regressions.php"
php "$root/tests/v2420-release-truth-regressions.php"
python3 -m py_compile "$root/scripts/build-release.py" "$root/scripts/source-tree-hash.py" "$root/scripts/verify-manifest.py"
a="${TMPDIR:-/tmp}/file06-v2.4.20-a.zip"
b="${TMPDIR:-/tmp}/file06-v2.4.20-b.zip"
...
echo "All File 06 v2.4.20 automated checks, inherited review matrices, twenty-first-cycle regressions and deterministic package comparison passed."
