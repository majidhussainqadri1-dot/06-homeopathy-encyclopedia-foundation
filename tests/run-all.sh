...
a="${TMPDIR:-/tmp}/file06-v2.4.7-a.zip"
b="${TMPDIR:-/tmp}/file06-v2.4.7-b.zip"
...
echo "All File 06 v2.4.7 automated checks, inherited review matrices, eighth ten-round regressions and deterministic package comparison passed."
