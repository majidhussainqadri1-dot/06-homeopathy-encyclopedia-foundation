...
a="${TMPDIR:-/tmp}/file06-v2.4.6-a.zip"
b="${TMPDIR:-/tmp}/file06-v2.4.6-b.zip"
...
echo "All File 06 v2.4.6 automated checks, inherited review matrices, seventh ten-round regressions and deterministic package comparison passed."
