...
a="${TMPDIR:-/tmp}/file06-v2.4.13-a.zip"
b="${TMPDIR:-/tmp}/file06-v2.4.13-b.zip"
...
echo "All File 06 v2.4.13 automated checks, inherited review matrices, fourteenth ten-round regressions and deterministic package comparison passed."
