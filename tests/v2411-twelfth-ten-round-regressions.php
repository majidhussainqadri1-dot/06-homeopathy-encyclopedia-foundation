...
$lang_compact=preg_replace('/\s+/','',$lang);
$public_source_count=substr_count($lang_compact,"'source_version'=>\$public_source_version");
v2411_ok(10,false!==strpos($lang,'$public_source_version')&&$public_source_count>=2&&!preg_match("/'source_version'\s*=>\s*\(int\)\s*\$(?:row\['source_version'\]|concept\['current_version'\])/",$lang),'public translation DTO exposes internal version-row identifiers');
v2411_ok(10,preg_match('/ \* Version: 2\.4\.(?:11|12|13|14|15|16|17|18|19)/',$bootstrap)&&preg_match("/HE_VERSION', '2\.4\.(?:11|12|13|14|15|16|17|18|19)/",$bootstrap)&&preg_match("/HE_CONTRACT_VERSION', '2\.4\.(?:11|12|13|14|15|16|17|18|19)/",$bootstrap)&&false!==strpos($bootstrap,"'future_hardening_version'=>"),'historical v2.4.11 release controls do not tolerate a later current v2.4.x candidate');
