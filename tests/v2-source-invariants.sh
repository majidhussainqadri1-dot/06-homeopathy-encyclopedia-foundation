...
grep -Eq "Version: 2\.4\.(15|16|17|18|19)" "$plugin/homeopathy-encyclopedia.php"
grep -q "HE_SCHEMA_VERSION', 10" "$plugin/homeopathy-encyclopedia.php"
grep -Eq "HE_CONTRACT_VERSION', '2\.4\.(15|16|17|18|19)" "$plugin/homeopathy-encyclopedia.php"
...
echo "File 06 source-tree invariants passed under current v2.4.x candidate."
