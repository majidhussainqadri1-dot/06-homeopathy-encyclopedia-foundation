...
grep -q "Version: 2.4.3" "$plugin/homeopathy-encyclopedia.php"
grep -q "HE_SCHEMA_VERSION', 10" "$plugin/homeopathy-encyclopedia.php"
grep -q "HE_CONTRACT_VERSION', '2.4.3" "$plugin/homeopathy-encyclopedia.php"
...
echo "File 06 v2.4.3 source-tree invariants passed."
