...
foreach(array('Version: 2.4.1',"HE_VERSION', '2.4.1","HE_CONTRACT_VERSION', '2.4.1",'class-he-v241-governance.php','class-he-v241-runtime-guard.php','class-he-v241-before-callback-normalizer.php','class-he-v241-public-dto-guard.php','native_object_scope_required','editor_type_assignment_required','reviewer_assignment_required','admin_and_composer_scope_enforced','legacy_unverified_scheduler_disabled','core_maintenance_serialized','future_maintenance_serialized','core_numeric_enumeration_blocked') as $x)t('b',$x,'bootstrap '.$x);
foreach(array('META_EDITOR_TYPES','META_REVIEW_ASSIGNMENTS','save_editor_scope','save_reviewer_assignment','editor_type_allowed','reviewer_assigned','file06-integrity-apply','file06-research-transition','file06-dataset-approval','file06-future-claim-edit','file06-future-translation-edit','maintenance_serialized','LEASE_OPTION') as $x)t('g',$x,'governance '.$x);
...
if($fail){fwrite(STDERR,"File 06 v2.4.1 second-80 invariants FAILED:\n- ".implode("\n- ",$fail)."\n");exit(1);}echo "File 06 v2.4.1 second-80 invariants passed.\n";
