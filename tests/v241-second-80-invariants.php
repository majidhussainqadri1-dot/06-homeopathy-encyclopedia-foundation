...
if($fail){fwrite(STDERR,"File 06 v2.4.1 second-80 regression controls FAILED under v2.4.2:\n- ".implode("\n- ",$fail)."\n");exit(1);}echo "File 06 v2.4.1 second-80 controls remain present under v2.4.2.\n";
