...
Q(1,H('b',"HE_VERSION', '2.4.2")&&H('b',"HE_CONTRACT_VERSION', '2.4.2"),'exact version/contract');
...
if($n!==80)$bad[]='matrix count '.$n;if($bad){fwrite(STDERR,"File 06 v2.4.2 corrected third-80 matrix FAILED:\n- ".implode("\n- ",$bad)."\n");exit(1);}echo "File 06 v2.4.2 corrected third fresh 80-round matrix passed (80/80).\n";
