...
a(false!==strpos($b,"HE_VERSION', '2.4.1"),'version');a(false!==strpos($b,"HE_SCHEMA_VERSION', 10"),'schema');a(false!==strpos($b,"HE_CONTRACT_VERSION', '2.4.1"),'contract');a(false!==strpos($b,"'staging_accepted' => false")&&false!==strpos($b,"'live_deployed' => false"),'release truth');
