...
a(false!==strpos($b,"HE_VERSION', '2.4.6"),'version');a(false!==strpos($b,"HE_SCHEMA_VERSION', 10"),'schema');a(false!==strpos($b,"HE_CONTRACT_VERSION', '2.4.6"),'contract');
...
if($fail){fwrite(STDERR,"File 06 core invariants FAILED:\n- ".implode("\n- ",$fail)."\n");exit(1);}echo "File 06 current core invariants passed under v2.4.6.\n";
