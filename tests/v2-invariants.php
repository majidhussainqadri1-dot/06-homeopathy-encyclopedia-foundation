...
a((bool)preg_match("/HE_VERSION', '2\\.4\\.(?:15|16|17)/",$b),'version');a(false!==strpos($b,"HE_SCHEMA_VERSION', 10"),'schema');a((bool)preg_match("/HE_CONTRACT_VERSION', '2\\.4\\.(?:15|16|17)/",$b),'contract');
