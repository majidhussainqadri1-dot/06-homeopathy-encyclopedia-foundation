...
v2412_ok(10,preg_match('/ \* Version: 2\.4\.(?:12|13|14|15|16|17|18)/',$bootstrap)&&preg_match("/HE_VERSION', '2\.4\.(?:12|13|14|15|16|17|18)/",$bootstrap)&&preg_match("/HE_CONTRACT_VERSION', '2\.4\.(?:12|13|14|15|16|17|18)/",$bootstrap)&&false!==strpos($bootstrap,"'future_hardening_version'=>"),'historical v2.4.12 release controls do not tolerate a later current v2.4.x candidate');
