...
v2412_ok(10,false!==strpos($bootstrap,' * Version: 2.4.12')&&false!==strpos($bootstrap,"define( 'HE_VERSION', '2.4.12' );")&&false!==strpos($bootstrap,"define( 'HE_CONTRACT_VERSION', '2.4.12' );")&&false!==strpos($bootstrap,"'future_hardening_version'=>'2.4.12'"),'runtime/contract/future hardening truth is not v2.4.12');
