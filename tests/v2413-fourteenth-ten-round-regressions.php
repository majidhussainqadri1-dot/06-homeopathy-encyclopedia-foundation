...
v2413_ok(10,preg_match('/ \* Version: 2\.4\.(?:13|14|15|16|17)/',$bootstrap)&&preg_match("/HE_VERSION', '2\.4\.(?:13|14|15|16|17)/",$bootstrap)&&preg_match("/HE_CONTRACT_VERSION', '2\.4\.(?:13|14|15|16|17)/",$bootstrap)&&preg_match("/future_hardening_version'=>'2\.4\.(?:13|14|15|16|17)/",$bootstrap),'runtime/contract/future hardening truth is not compatible with the historical v2.4.13 contract under current v2.4.x hardening');
v2413_ok(10,preg_match('/Stable tag: 2\.4\.(?:13|14|15|16|17)/',$readme)&&false!==strpos($runall,'v2413-fourteenth-ten-round-regressions.php')&&preg_match('/file06-v2\.4\.(?:13|14|15|16|17)-a\.zip/',$runall)&&preg_match('/All File 06 v2\.4\.(?:13|14|15|16|17) automated checks/',$runall),'aggregate/package release truth no longer tolerates the current v2.4.x candidate');
